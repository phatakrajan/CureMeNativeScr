    ...
    private items = new Array<Item>(
        {
            ...
            subitems: [
                { id: 1, name: "Acidity", path: "~/images/SelfCure/Acidity.png", subitems: null, description:"/html/SelfCure/Acidity.html"  },
                { id: 2, name: "Intestinal Worms", path: "~/images/SelfCure/Intestinal_Worms.png", subitems: null, description:"/html/SelfCure/Intestinal_Worms.html" },
                { id: 3, name: "Gastritis", path: "~/images/SelfCure/Gastritis.png", subitems: null, description:"/html/SelfCure/Gastritis.html" },
                { id: 4, name: "Mouth Ulcers", path: "~/images/SelfCure/Mouth_Ulcers.png", subitems: null, description:"/html/SelfCure/Mouth_Ulcers.html" },
                { id: 5, name: "Acne", path: "~/images/SelfCure/Acne.png", subitems: null, description:"/html/SelfCure/Acne.html" },
                { id: 6, name: "Eczema", path: "~/images/SelfCure/Eczema.png", subitems: null, description:"/html/SelfCure/Eczema.html" },
                { id: 7, name: "Age spots", path: "~/images/SelfCure/Age_spots.png", subitems: null, description:"/html/SelfCure/Age_spots.html" },
                { id: 8, name: "Gas/Flatulence", path: "~/images/SelfCure/Gas.png", subitems: null, description:"/html/SelfCure/Gas.html" },
                { id: 9, name: "Obesity", path: "~/images/SelfCure/Obesity.png", subitems: null, description:"/html/SelfCure/Obesity.html" },
                { id: 10, name: "Common Cold", path: "~/images/SelfCure/Common_Cold.png", subitems: null, description:"/html/SelfCure/Common_Cold.html" },
                { id: 11, name: "Sinusitis", path: "~/images/SelfCure/Sinusitis.png", subitems: null, description:"/html/SelfCure/Sinusitis.html" },
                { id: 12, name: "Tonsillitis", path: "~/images/SelfCure/Tonsillitis.png", subitems: null, description:"/html/SelfCure/Tonsillitis.html" },
                { id: 13, name: "Nose Bleeding", path: "~/images/SelfCure/Nose_Bleeding.png", subitems: null, description:"/html/SelfCure/Nose_Bleeding.html" },
                { id: 14, name: "Varicose Veins", path: "~/images/SelfCure/Varicose_Veins.png", subitems: null, description:"/html/SelfCure/Varicose_Veins.html" },
                { id: 15, name: "Migraine", path: "~/images/SelfCure/Migraine.png", subitems: null, description:"/html/SelfCure/Migraine.html" },
                { id: 16, name: "Vertigo", path: "~/images/SelfCure/Vertigo.png", subitems: null, description:"/html/SelfCure/Vertigo.html" },
                { id: 17, name: "Insomnia", path: "~/images/SelfCure/Insomnia.png", subitems: null, description:"/html/SelfCure/Insomnia.html" },
                { id: 18, name: "Depression", path: "~/images/SelfCure/Depression.png", subitems: null, description:"/html/SelfCure/Depression.html" },
                { id: 19, name: "Stress", path: "~/images/SelfCure/Stress.png", subitems: null, description:"/html/SelfCure/Stress.html" },
            ]
        },
        {
        ...
        },
        {
            ...
            description: "In case you cannot find help for your problems from the solution we have provided then you have an option to contact our doctors team.",
            subitems: 
            [
